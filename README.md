...
<head>
  ...
  <style>
    ...
    :root { --text-light: #4882f6; --text-dark: #f8fafc; --brand: #2563eb; --page-bg-light: #ffffff; --page-bg-dark: #0b1220; }
    ...
    .bg-gradient-to-br.from-blue-50 { background-color: #a3c0e7 !important; }
